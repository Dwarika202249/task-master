...
export function SearchBar() {
  ...
  return (
    <div className="relative">
      ...
      <input
        className="w-full pl-12 pr-10 py-3 rounded-xl bg-surface border border-border/50 text-white placeholder-muted focus:outline-none focus:ring-2 focus:ring-primary transition-all"
