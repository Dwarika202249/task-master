  ...
  return (
    <form onSubmit={submit} className="bg-[#11111a] border border-border rounded-2xl p-6 shadow-card space-y-4">
      <div>
        ...
        <input
          id="title"
          className="w-full px-4 py-3 rounded-xl bg-[#302f40] border border-border text-white placeholder-muted focus:outline-none focus:ring-2 focus:ring-primary transition-all"
      ...
      <div>
        ...
        <textarea
          id="description"
          className="w-full px-4 py-3 rounded-xl bg-[#302f40] border border-border text-white placeholder-muted focus:outline-none focus:ring-2 focus:ring-primary transition-all resize-none"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-2 rounded-lg bg-[#302f40] border border-border text-white focus:outline-none focus:ring-2 focus:ring-primary transition-all"
          >
            <option>Work</option>
